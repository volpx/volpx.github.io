...
For graphic stuff we installed `xorg-server xf86-video-intel sddm htop plasma plasma-nm firefox konsole git fakeroot tlp kwrite konsole dolphin` and enable the services:
{% highlight bash %}
